  ...
  return (
    <Container>
      <FadeIn className="mt-24 text-center">
        <h1>
          <span className="block font-display text-2xl font-semibold text-blue-100">{eyebrow}</span>
        ...
        <div className="mt-6 max-w-5xl text-xl text-gray-500 mx-auto">{children}</div>
      </FadeIn>
    </Container>
  );
}
