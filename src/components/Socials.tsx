...
export const socialMediaProfiles = [
  { title: 'Linkedin', href: 'https://www.linkedin.com/in/bidisha-mondal-42a1bb145/', icon: LinkedinIcon },
  { title: 'GitHub', href: 'https://github.com/mondalbidisha', icon: GitHubIcon },
];
